...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: ["CallaCourseCommandValidation.swift", "CallaCoursePresentation.swift", "CallaCopilotCommandValidation.swift", "CallaAgyLoginParsing.swift", "TutorEngineGate.swift", "TutorAgyAttachmentStager.swift"]
        ),
        .target(
