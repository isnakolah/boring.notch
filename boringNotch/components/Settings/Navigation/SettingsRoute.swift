...
extension SettingsRoute {
    ...
    init(legacyIdentifier raw: String) {
        ...
        case "CopilotIntelligence", "copilotIntelligence": self = .init(.copilot, [.copilotIntelligence])
        ...
        case "CopilotTranscription", "copilotTranscription": self = .init(.copilot, [.copilotTranscription])
        ...
        case "tutorAccess": self = .init(.tutor, [.tutorAccess])
        case "tutorEngine": self = .init(.tutor, [.tutorEngine])
        case "Sweep", "sweep": self = .init(.sweep)
        case "sweepCleanUp": self = .init(.sweep, [.sweepCleanUp])
